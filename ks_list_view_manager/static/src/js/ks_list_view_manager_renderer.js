...
//                    fix_body("fixed");
                        ...
                        if ((!this.ks_list_view_data.ks_dynamic_list_show) && optional_col.length == 0){
                                ...
                                if ($(self.$('table').find('.tableFloatingHeaderOriginal').find('tr')[0]).find('.o_activity_exception_cell').length == 0){
                                    $(self.$('table').find('.tableFloatingHeaderOriginal').find('tr')[0]).append($('<th data-name="activity_exception_decoration" class="o_activity_exception_cell ks_set_width" tabindex="-1" title="" style="width: 20px;"></th>'))
                                }
                            }
